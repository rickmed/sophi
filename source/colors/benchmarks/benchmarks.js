#!/usr/bin/env node
// from https://github.com/sindresorhus/yoctocolors
...
suite
	...
	.addTest("sophi/colors/methods", () => {
		out = ink.red("Add plugin to use time limit")
		out = ink.green("Add plugin to use time limit")
		out = ink.blue("Add plugin to use time limit")
	})
	.addTest("sophi/colors/proto", () => {
		out = "Add plugin to use time limit".red
		out = "Add plugin to use time limit".gren
		out = "Add plugin to use time limit".blue
	})
